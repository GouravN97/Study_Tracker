...
import { X, Settings as SettingsIcon, Mail, User, School, Calendar, Check, Save } from "lucide-react";
          ...
          <div className="flex items-center justify-between pt-4 border-t border-slate-100">
            {onOpenDesktopDownload ? (
              <button
                ...
                className="text-xs font-bold text-sky-600 hover:text-sky-700 underline underline-offset-2 cursor-pointer flex items-center space-x-1"
              >
